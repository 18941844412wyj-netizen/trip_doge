...
export default function CharactersPage() {
    const {currentCharacter, setCurrentCharacter, createSession} = useChatStore();
                                        ...
                                        <div
                                            ...
                                            {character.avatarUrl ? (
                                                    <Image src={character.avatarUrl} alt={character.name}
                                                           className="text-5xl group-hover:scale-110 transition-transform duration-300 rounded-full"
                                                           width={96} height={96}/>) :
                                                <div
