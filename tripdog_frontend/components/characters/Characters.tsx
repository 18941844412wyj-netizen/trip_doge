        ...
        <div className="p-4  w-full mx-auto">
                ...
                {filteredContacts.map((contact, index) => (
                    ...
                    >
                        <div className="flex items-center">
                            ...
                            <div className="relative">
                                <div
                                    className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-100 to-pink-100 flex items-center justify-center text-lg shadow-inner">
                                    {contact.avatarUrl ? (
                                        <Image
                                ...
                                <div
                                    className="absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white bg-green-500"></div>
                            </div>
            ...
            {filteredContacts.length === 0 && (
                <div className="text-center py-8">
                    <div
                        className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg shadow-purple-200/30 border border-white/50 inline-block">
